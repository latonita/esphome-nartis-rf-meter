...
static constexpr uint8_t NARTIS_BASEBAND_BANK[29] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x60,  // PKT17-PKT24 (PKT24=0x60: WHITEN_EN bit 0x04 CLEAR -> whitening OFF; seed[8]=1, seed_type 2, PN9-CCITT all inert)
    0xFF, 0x00, 0x00, 0x1F, 0x10                      // PKT25-PKT29 (0xFF=whiten seed[7:0]; inert while disabled. If enabled, seed=0x1FF; enable would need PKT24=0x64)
};
